...
function ArtGallery() {
  ...
  // Если меньше 3 страниц в конце, смещаем в начало
  ...
  return (
    ...
    {/* small screen */}
      <div className="flex md:hidden h-screen bg-[url('/images/kunsthubsmall.png')] bg-cover bg-center">
        <div className=" flex flex-col h-screen justify-center gap-5">
          <h1 className="text-left mx-auto  text-6xl font-bold flex flex-col">KUNST <p className="flex">HUB <img src="/images/kunsthubeye.png" alt="eye" className="flex md:hidden" /></p></h1>
          
          
          <h2 className="text-sm text-center mx-auto font-bold max-w-[80%]">Это Галлерея Здесь вы найдете все произведения искусства, которые когда-либо были представлены на наших выставках или просто загружены на сайт.</h2>
    ...
    <div className=" md:flex hidden h-screen bg-[url('/images/kunsthubphoto.png')] bg-cover bg-center">
        <div className="w-full flex flex-col h-screen justify-center gap-5">
          ...
          <h2 className="text-center mx-auto font-semibold max-w-[80%] text-3xl">Это Галлерея Здесь вы найдете все произведения искусства, которые когда-либо были представлены на наших выставках или просто загружены на сайт.</h2>
