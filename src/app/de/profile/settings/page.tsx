...
function Page() {
  ...
  return (
    <>
      <Navbar />
      <div className="h-screen flex flex-col pt-40 mx-10 gap-10">
        <button
          onClick={logout}
        ...
        <ul className="text-sm md:text-lg xl:text-xl flex flex-col xl:gap-6 gap-1 italic">
          <li>
            <a href="/de/impressum" className="underline text-gray-600">
              Impressum*
            </a>
          </li>
          <li>
            <a href="/de/agb/" className="underline text-gray-600">
              AGB*
            </a>
          </li>

          <li>
            <a href="/de/datenschutzerklarung" className="underline text-gray-600">
              Datenshutzerklärung*
            </a>
          </li>
        </ul>
